...
/***/ function(module, exports, __webpack_require__) {
	...
	var _slides = __webpack_require__(166);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        null,
	        this.state.currentIndex !== 0 ? _react2.default.createElement(
	          "a",
	          { onClick: this.previous },
	          "Previous"
	        ) : '',
	        this.state.currentIndex > 0 && this.state.currentIndex < this.state.slides.length - 1 ? ' | ' : '',
	        this.state.currentIndex !== this.state.slides.length - 1 ? _react2.default.createElement(
	          "a",
	          { onClick: this.next },
	          "Next"
	        ) : '',
	        _react2.default.createElement(_slide2.default, { slide: this.getCurrentSlide() })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Slide = (function (_BaseComponent) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".slide {\n  background: lightgray;\n  border: solid 2px gray; }\n  .slide .header {\n    background: darkolivegreen;\n    color: white; }\n    .slide .header .title {\n      font-size: 20px;\n      display: inline-block;\n      background: black;\n      padding: 20px; }\n  .slide .body {\n    background: white;\n    padding: 10px;\n    min-height: 600px; }\n\n#content {\n  width: 80%;\n  margin: auto; }\n\nbody {\n  font-family: sans-serif; }\n", "", {"version":3,"sources":["/./public/css/slide.scss","/./public/css/main.scss"],"names":[],"mappings":"AAAA;EACC,sBAAsB;EACtB,uBAAuB,EAmBvB;EArBD;IAKE,2BAA2B;IAC3B,aAAa,EAQb;IAdF;MASG,gBAAgB;MAChB,sBAAsB;MACnB,kBAAkB;MACrB,cAAc,EACd;EAbH;IAiBE,kBAAkB;IAClB,cAAc;IACd,kBAAkB,EAClB;;AClBF;EACC,WAAW;EACX,aAAa,EACb;;AAED;EACC,wBAAwB,EACxB","file":"main.scss","sourcesContent":[".slide{\n\tbackground: lightgray;\n\tborder: solid 2px gray;\n\t\n\t.header{\n\t\tbackground: darkolivegreen;\n\t\tcolor: white;\n\t\t\n\t\t.title{\n\t\t\tfont-size: 20px;\n\t\t\tdisplay: inline-block;\n    \t\tbackground: black;\n\t\t\tpadding: 20px;\n\t\t}\n\t}\n\t\n\t.body{\n\t\tbackground: white;\n\t\tpadding: 10px;\n\t\tmin-height: 600px;\n\t}\n}","@import \"slide\";\n\n#content{\n\twidth: 80%;\n\tmargin: auto;\n}\n\nbody{\n\tfont-family: sans-serif;\n}"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports) {
	...
	var SlidesProvider = (function () {
		function SlidesProvider() {
			_classCallCheck(this, SlidesProvider);
		}

		_createClass(SlidesProvider, [{
			key: "getSlides",
